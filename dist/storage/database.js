...
export function upsertSession(db, sessionID, startedAt, lastActivity) {
    db.query(`INSERT INTO sessions (id, started_at, last_activity, request_count)
...
export function getModelStats(db) {
